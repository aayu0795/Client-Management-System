# Generated by Django 3.0.7 on 2020-06-22 06:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('F', 'Female'), ('O', 'Others'), ('M', 'Male')], max_length=1, verbose_name='Gender')),
                ('gender_en_us', models.CharField(choices=[('F', 'Female'), ('O', 'Others'), ('M', 'Male')], max_length=1, null=True, verbose_name='Gender')),
                ('gender_es', models.CharField(choices=[('F', 'Female'), ('O', 'Others'), ('M', 'Male')], max_length=1, null=True, verbose_name='Gender')),
